                            ...
                            <Form id="add-product-form" method="post" role="form">
                                <div className="grid grid-cols-4 gap-5">
                                    ...
                                    <div className="col-span-3">
                                        <InputField id="product-name-input" name="product-name" type="text" autoComplete="product-name" style="font-ember-regular text-xs" required />
                                    </div>
                                    ...
                                    <div className="col-span-3">
                                        <div className="flex flex-row items-center">
                                            <InputField id="price-input" name="price" autoComplete="price" style="font-ember-regular" required />
                                    ...
                                    <div className="col-span-3">
                                        <div className="flex flex-row items-center">
                                            <InputField id="discount-input" name="discount" type="number" autoComplete="discount"  style="font-ember-regular"  />
                                    ...
                                    <div className="col-span-3">
                                        <InputField id="image-url-input" name="image-url" type="text" autoComplete="image-url"  style="font-ember-regular text-xs"  />
                                    </div>
